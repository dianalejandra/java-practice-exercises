...
/**
 * Make a program where user can type a limit number (example 100), and show a
 * counter that shows each number until the number input limit (starts with number 1)
 * 
