 ...
 * in each column.
 * I. A program is needed that allows loading the matrix with the number of 
 ...
 * to travel in the morning, at noon or at night) and the number of tickets they need.
 * 
 ...
 * are made per day. Therefore, to finalize the sales, the word “finish” is entered.
 * 
 * 
 * 
 * Una compañía de vuelos cuenta con 6 destinos a los que realiza 3 vuelos diariamente,
 * uno por la mañana, otro al mediodía y otro por la noche. Para administrar estos datos,
 * utiliza una matriz, donde cada fila es un destino y en cada columna se guarda
 ...
 * de destino al que quiere dirigirse, el número de vuelo (dependiendo si quiere
 * viajar a la mañana, al mediodía o a la noche) y la cantidad de pasajes que necesita.
 * 
 * III. A partir de la solicitud del usuario, el programa debe controlar si hay
 * la cantidad suficiente de asientos para la cantidad de pasajes que se requiere.
 * En caso de que así sea, se debe mostrar un cartel por pantalla que diga “su 
 * reserva fue realizada con éxito” y se debe descontar del total de asientos los
 * solicitados por el usuario. En caso de no haber más asientos disponibles, se
 * debe informar otro cartel que diga “disculpe, no se pudo completar su operación
 * dado que no hay asientos disponibles”.
 * 
 * Desde la compañía de vuelos manifiestan que NO CONOCEN cuantas ventas/reservas
 * se hacen por día. Por lo cual, para finalizar las ventas se ingresa la palabra “finish”.
 */
